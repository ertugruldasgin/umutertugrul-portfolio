...
const COLORS: ColorPalette[] = [
  {
    ...
    colors: [
      { cssVar: "var(--mt-foreground)", label: "Default" },
  ...
  },
  {
    ...
    colors: [
      { cssVar: "var(--mt-surface)", label: "White", darkLabel: "Black" },
  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <ToggleGroupItem
          tabIndex={0}
          className="relative size-8 rounded-lg! p-0 hover:cursor-pointer hover:ring-2 hover:ring-primary-hover"
          value={color.cssVar}
          aria-label={label}
